...
const AdminDashboard = () => {
  ...
  const fetchPendingRestaurants = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:5000/api/restaurants/admin/pending-registrations', {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {pendingRestaurants.length === 0 ? (
        <p className="text-gray-500 text-center">No pending registration requests</p>
      ) : (
