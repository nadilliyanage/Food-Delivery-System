...
const DeliveryPersonnelRequests = () => {
  ...
  const tabs = [
    { id: 'pending', label: 'Pending Requests', count: registrations.pending.length },
    { id: 'approved', label: 'Approved Requests', count: registrations.approved.length },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Delivery Personnel Registration Requests</h1>
