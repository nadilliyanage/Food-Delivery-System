...
const RestaurantDetails = () => {
  ...
  const fetchMenuItems = async () => {
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/restaurants/${restaurantId}/menu`, {
        headers: {
    ...
    try {
      ...
      if (result.isConfirmed) {
        ...
        const response = await axios.delete(
          `${import.meta.env.VITE_API_URL}/api/restaurants/${restaurantId}/menu/${menuItemId}`,
          {
            headers: {
              Authorization: `Bearer ${token}`
            }
      ...
      <div className="mb-8">
        ...
        {menuItems.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <p className="text-gray-600">No menu items found. Add your first menu item!</p>
          </div>
        ) : (
